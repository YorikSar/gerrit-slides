...
function hasClass(object, className) {
	if (object.tagName == 'svg' || !object.className) return false;
...
function GetElementsWithClassName(elementName,className) {
    if (document.getElementsByClassName && elementName == '*') return document.getElementsByClassName(className);
